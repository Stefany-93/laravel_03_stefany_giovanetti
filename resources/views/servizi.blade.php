...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid bg-body-secondary bg-te-background">
            <div class="row h-75 justify-content-center align-items-center">
                <div class="col-12">
                    <h1 class="text-center display-4 shadow text-bianco">
                        I NOSTRI SERVIZI
                    </h1>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                        @foreach ($services as $service)
                            <div class="col-12 col-md-3 py-5">
                                <div class="card mx-auto card-custom card-te-custom" style="width: 18rem;">
                                    <img src="{{ $service['img']}}" alt="" class="img-custom">
                                    <div class="card-body">
                                        <h5 class="card-title">{{$service['name']}}</h5>
                                        <p>{{$service['description']}}</p>
                                        <a href="{{route('service.detail', ['id' => $service['id']])}}" class="btn btn-primary btn-te">Scopri di più</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
