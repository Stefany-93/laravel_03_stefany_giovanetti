...
<html lang="en">
    <head>
        ...
        <title>Capybath-I nostri servizi</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-body-secondary bg-te-background">
            <div class="row h-75 justify-content-center align-items-center">
                <div class="col-12">
                    <h1 class="text-center display-4 shadow text-bianco">{{$service['name']}}</h1>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-md-6">
                    <img src="{{$service['img']}}" alt="" class="img-cappy">
                </div>
                <div class="col-12 col-md-6">
                    <h2 class="text-bianco">{{$service['description']}}</h2>
                    <p class="text-bianco"> {{$service['intero']}}</p>
                </div>
            </div>
        </div>
