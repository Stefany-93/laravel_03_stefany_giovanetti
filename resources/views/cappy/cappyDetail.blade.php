...
<html lang="en">
    <head>
        ...
        <title>Capybath-I nostri capibara</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-body-secondary bg-chi-background">
            <div class="row h-75 justify-content-center align-items-center">
                <div class="col-12">
                    <h1 class="text-center display-4 shadow text-bianco">Conosci il capibara {{$cappy['name']}}</h1>
                </div>
            </div>
            <div class="row justify-content-center align-items-center">
                <div class="col-12 col-md-6">
                    <img src="{{$cappy['img']}}" alt="" class="img-cappy">
                </div>
                <div class="col-12 col-md-6">
                    <h2 class="text-bianco">{{$cappy['name']}}</h2>
                    <p class="text-bianco"> {{$cappy['description']}}</p>
                </div>
            </div>
        </div>
