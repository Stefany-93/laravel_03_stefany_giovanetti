...
<html lang="en">
    <head>
        ...
        <title>Capybath-Chi siamo</title>
    ...
    <body>
        ...
        <div class="container-fluid bg-body-secondary bg-chi-background">
            ...
            <div class="row justify-content-center align-items-center">
                        @foreach ($cappies as $cappy)
                            <div class="col-12 col-md-3 py-5">
                                <div class="card mx-auto card-custom" style="width: 18rem;">
                                     <img src="{{$cappy['img']}}" alt="" class="img-custom">
                                    <div class="card-body">
                                        <h5 class="card-title">{{$cappy['name']}}</h5>
                                        <a href="{{route('cappy.detail', ['id' => $cappy['id']])}}" class="btn btn-primary">Conosciamoci</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
